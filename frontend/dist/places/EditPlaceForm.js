        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        e.preventDefault();
                        return [4, fetch("http://localhost:5000/places/".concat(place.placeId), {
                                method: 'PUT',
                                headers: {
